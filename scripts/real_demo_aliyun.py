...
DEMO_DB = r'D:\aiCode\Hermes\aiTest\ai-agent-governance\tokenkeeper\examples\aliyun_real.db'
...
def main():
    ...
    try:
        ...
        cost = calculate_cost('glm-5.2', resp['usage']['prompt_tokens'], resp['usage']['completion_tokens'])
        guard.record(
            model='glm-5.2',
